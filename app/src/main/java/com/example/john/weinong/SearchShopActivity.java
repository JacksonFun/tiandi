...
public class SearchShopActivity extends Activity implements OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_search:// 搜索按钮
                ...
                if (TextUtils.isEmpty(searchContent)) {
                    ...
                    intent.setClass(SearchShopActivity.this,NewsActivity.class);
                    intent.putExtra("newstitle",searchContent);
            ...
            case R.id.btn_clear_history:// 清除历史记录
                ...
                lvHistory.setVisibility(View.GONE);
                btnClearHistory.setVisibility(View.GONE);
                Toast.makeText(SearchShopActivity.this, "清空历史记录成功", Toast.LENGTH_SHORT).show();
                break;
